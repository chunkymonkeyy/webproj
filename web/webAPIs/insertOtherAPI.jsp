...
<%@page language="java" import="model.product.DbMods" %>
...
<%
    ...
    StringData errorMsgs = new StringData(); //hold the field level error messages

    String jsonInsertData = request.getParameter("jsonData"); //hold the user's pre-validated data
    if (jsonInsertData == null) {
        ...
        if (errorMsgs.errorMsg.length() == 0) { // means db connection is ok
            System.out.println("insertProductAPI.jsp ready to insert");
